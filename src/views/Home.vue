<template>
  <b-container>
    ...
    <b-row>
      <b-col sm="8" md="6" lg="5"><MultiSelector /></b-col>
      <b-col sm="8" md="6" lg="2"> <Reviews class="mt-4 mt-md-0" /></b-col
      ><b-col sm="8" md="6" lg="5">
        ...
        <div class="d-flex">
          ...
          <button class="btn btn-sm btn-primary mx-4 mx-md-5 mb-3">Save</button>
        </div>
        <Comments
